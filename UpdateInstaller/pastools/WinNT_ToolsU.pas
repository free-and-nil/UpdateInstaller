...
function AdjustTokenPrivileges (TokenHandle: THandle; DisableAllPrivileges: BOOL;
                       ...
                       external advapi32 name 'AdjustTokenPrivileges'; overload;
    ...
    begin
        ...
        begin
            ...
            if (AdjustTokenPrivileges (hProcessToken, false, TP,
            						   SizeOf (TTokenPrivileges), TP_Prev,
                                       dwReturnLength)) then
                FEnabled := true;
        end; { if }
    end; { if }
...
begin
    ...
    begin
        ...
        FillChar (PreviousState{%H-}, SizeOf (TTokenPrivileges), #0);

    	VerifyApi (AdjustTokenPrivileges (hProcessToken, true, TP_Prev,
                                          SizeOf (TTokenPrivileges),
                                          PreviousState, dwReturnLength));
    end; { if }
        ...
        try
            ...
            begin
                ...
                if (AdjustTokenPrivileges (hToken, false, TokenPriv,
                                           ...
                                           PrefTokenPriv, dwReturnLen)) then
