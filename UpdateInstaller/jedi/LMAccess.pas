...
var
  ...
  NetUserAdd : function (servername: LPCWSTR; level: DWORD; buf: Pointer;
    parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetUserEnum}
  NetUserEnum : function (servername: LPCWSTR; level: DWORD; filter: DWORD;
    var bufptr: LPBYTE; prefmaxlen: DWORD; var entriesread: DWORD;
    var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetUserGetInfo}
  NetUserGetInfo : function (servername: LPCWSTR; username: LPCWSTR; level: DWORD;
    var bufptr: LPBYTE): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetUserSetInfo}
  NetUserSetInfo : function (servername: LPCWSTR; username: LPCWSTR; level: DWORD;
    buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetUserDel}
  NetUserDel : function (servername: LPCWSTR; username: LPCWSTR): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetUserGetGroups}
  NetUserGetGroups : function (servername: LPCWSTR; username: LPCWSTR; level: DWORD;
    var bufptr: LPBYTE; prefmaxlen: DWORD; var entriesread: DWORD;
    var totalentries: DWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetUserSetGroups}
  NetUserSetGroups : function (servername: LPCWSTR; username: LPCWSTR; level: DWORD;
    buf: Pointer; num_entries: DWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetUserGetLocalGroups}
  NetUserGetLocalGroups : function (servername: LPCWSTR; username: LPCWSTR;
    level: DWORD; flags: DWORD; var bufptr: LPBYTE; prefmaxlen: DWORD;
    var entriesread: DWORD; var totalentries: DWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetUserModalsGet}
  NetUserModalsGet : function (servername: LPCWSTR; level: DWORD;
    var bufptr: LPBYTE): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetUserModalsSet}
  NetUserModalsSet : function (servername: LPCWSTR; level: DWORD; buf: Pointer;
    parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetUserChangePassword}
  NetUserChangePassword : function (domainname, username, oldpassword,
    newpassword: LPCWSTR): NET_API_STATUS; stdcall = NIL;
...
var
  ...
  NetGroupAdd : function (servername: LPCWSTR; level: DWORD; buf: Pointer;
    parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetGroupAddUser}
  NetGroupAddUser : function (servername: LPCWSTR; GroupName: LPCWSTR;
    username: LPCWSTR): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetGroupEnum}
  NetGroupEnum : function (servername: LPCWSTR; level: DWORD; var bufptr: LPBYTE;
    prefmaxlen: DWORD; var entriesread: DWORD; var totalentries: DWORD;
    resume_handle: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetGroupGetInfo}
  NetGroupGetInfo : function (servername: LPCWSTR; groupname: LPCWSTR; level: DWORD;
    var bufptr: LPBYTE): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetGroupSetInfo}
  NetGroupSetInfo : function (servername: LPCWSTR; groupname: LPCWSTR; level: DWORD;
    buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetGroupDel}
  NetGroupDel : function (servername, groupname: LPCWSTR): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetGroupDelUser}
  NetGroupDelUser : function (servername: LPCWSTR; GroupName: LPCWSTR;
    Username: LPCWSTR): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetGroupGetUsers}
  NetGroupGetUsers : function (servername: LPCWSTR; groupname: LPCWSTR; level: DWORD;
    var bufptr: LPBYTE; prefmaxlen: DWORD; var entriesread: DWORD;
    var totalentries: DWORD; ResumeHandle: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetGroupSetUsers}
  NetGroupSetUsers : function (servername: LPCWSTR; groupname: LPCWSTR; level: DWORD;
    buf: Pointer; totalentries: DWORD): NET_API_STATUS; stdcall = NIL;
...
var
  ...
  NetLocalGroupAdd : function (servername: LPCWSTR; level: DWORD; buf: Pointer;
    parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetLocalGroupAddMember}
  NetLocalGroupAddMember : function (servername: LPCWSTR; groupname: LPCWSTR;
    membersid: PSID): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetLocalGroupEnum}
  NetLocalGroupEnum : function (servername: LPCWSTR; level: DWORD; var bufptr: LPBYTE;
    prefmaxlen: DWORD; var entriesread: DWORD; var totalentries: DWORD;
    resumehandle: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetLocalGroupGetInfo}
  NetLocalGroupGetInfo : function (servername: LPCWSTR; groupname: LPCWSTR;
    level: DWORD; var bufptr: LPBYTE): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetLocalGroupSetInfo}
  NetLocalGroupSetInfo : function (servername: LPCWSTR; groupname: LPCWSTR;
    level: DWORD; buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetLocalGroupDel}
  NetLocalGroupDel : function (servername, groupname: LPCWSTR): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetLocalGroupDelMember}
  NetLocalGroupDelMember : function (servername: LPCWSTR; groupname: LPCWSTR;
    membersid: PSID): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetLocalGroupGetMembers}
  NetLocalGroupGetMembers : function (servername: LPCWSTR; localgroupname: LPCWSTR;
    level: DWORD; var bufptr: LPBYTE; prefmaxlen: DWORD; var entriesread: DWORD;
    var totalentries: DWORD; resumehandle: PDWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetLocalGroupSetMembers}
  NetLocalGroupSetMembers : function (servername: LPCWSTR; groupname: LPCWSTR;
    level: DWORD; buf: Pointer; totalentries: DWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetLocalGroupAddMembers}
  NetLocalGroupAddMembers : function (servername: LPCWSTR; groupname: LPCWSTR;
    level: DWORD; buf: Pointer; totalentries: DWORD): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetLocalGroupDelMembers}
  NetLocalGroupDelMembers : function (servername: LPCWSTR; groupname: LPCWSTR;
    level: DWORD; buf: Pointer; totalentries: DWORD): NET_API_STATUS; stdcall = NIL;
...
var
  ...
  NetQueryDisplayInformation : function (ServerName: LPCWSTR; Level: DWORD;
    Index: DWORD; EntriesRequested: DWORD; PreferredMaximumLength: DWORD;
    var ReturnedEntryCount: DWORD; var SortedBuffer: Pointer): NET_API_STATUS; stdcall = NIL;

  {$EXTERNALSYM NetGetDisplayInformationIndex}
  NetGetDisplayInformationIndex : function (ServerName: LPCWSTR; Level: DWORD;
    Prefix: LPCWSTR; var Index: DWORD): NET_API_STATUS; stdcall = NIL;
...
var
    ...
    NetAccessAdd : function (servername: LPCWSTR; level: DWORD; buf: Pointer;
      parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;

    //#define NetAccessEnum RxNetAccessEnum

    {$EXTERNALSYM NetAccessEnum}
    NetAccessEnum : function (servername: LPCWSTR; BasePath: LPCWSTR; Recursive: DWORD;
    ...
    NetAccessGetInfo : function (servername: LPCWSTR; resource: LPCWSTR; level: DWORD;
      bufptr: Pointer): NET_API_STATUS; stdcall = NIL;

    //#define NetAccessSetInfo RxNetAccessSetInfo

    {$EXTERNALSYM NetAccessSetInfo}
    NetAccessSetInfo : function (servername: LPCWSTR; resource: LPCWSTR; level: DWORD;
      buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;

    //#define NetAccessDel RxNetAccessDel

    {$EXTERNALSYM NetAccessDel}
    NetAccessDel : function (servername, resource: LPCWSTR): NET_API_STATUS; stdcall = NIL;

    //#define NetAccessGetUserPerms RxNetAccessGetUserPerms

    {$EXTERNALSYM NetAccessGetUserPerms}
    NetAccessGetUserPerms : function (servername: LPCWSTR; UGname: LPCWSTR;
      resource: LPCWSTR; var Perms: DWORD): NET_API_STATUS; stdcall = NIL;
...
var
    ...
    NetGetDCName : function (servername: LPCWSTR; domainname: LPCWSTR;
      bufptr: Pointer): NET_API_STATUS; stdcall = NIL;

    {$EXTERNALSYM NetGetAnyDCName}
    NetGetAnyDCName : function (servername: LPCWSTR; domainname: LPCWSTR;
      bufptr: Pointer): NET_API_STATUS; stdcall = NIL;

    {$EXTERNALSYM I_NetLogonControl}
    I_NetLogonControl : function (ServerName: LPCWSTR; FunctionCode: DWORD;
      QueryLevel: DWORD; Buffer: Pointer): NET_API_STATUS; stdcall = NIL;

    {$EXTERNALSYM I_NetLogonControl2}
    I_NetLogonControl2 : function (ServerName: LPCWSTR; FunctionCode: DWORD;
      QueryLevel: DWORD; Data: Pointer; Buffer: Pointer): NET_API_STATUS; stdcall = NIL;
...
var
  ...
  NetEnumerateTrustedDomains : function (ServerName: LPWSTR; DomainNames: LPWSTR): NET_API_STATUS; stdcall = NIL;
...
begin
    ...
    hNetApi32 := LoadLibrary (netapi32lib);

    if (hNetApi32 = 0) then
    	exit;

    NetUserAdd := GPA (hNetApi32, 'NetUserAdd');
    NetUserEnum := GPA (hNetApi32, 'NetUserEnum');
    NetUserGetInfo := GPA (hNetApi32, 'NetUserGetInfo');
    NetUserSetInfo := GPA (hNetApi32, 'NetUserSetInfo');
    NetUserDel := GPA (hNetApi32, 'NetUserDel');
    NetUserGetGroups := GPA (hNetApi32, 'NetUserGetGroups');
    NetUserSetGroups := GPA (hNetApi32, 'NetUserSetGroups');
    NetUserGetLocalGroups := GPA (hNetApi32, 'NetUserGetLocalGroups');
    NetUserModalsGet := GPA (hNetApi32, 'NetUserModalsGet');
    NetUserModalsSet := GPA (hNetApi32, 'NetUserModalsSet');
    NetUserChangePassword := GPA (hNetApi32, 'NetUserChangePassword');
    NetGroupAdd := GPA (hNetApi32, 'NetGroupAdd');
    NetGroupAddUser := GPA (hNetApi32, 'NetGroupAddUser');
    NetGroupEnum := GPA (hNetApi32, 'NetGroupEnum');
    NetGroupGetInfo := GPA (hNetApi32, 'NetGroupGetInfo');
    NetGroupSetInfo := GPA (hNetApi32, 'NetGroupSetInfo');
    NetGroupDel := GPA (hNetApi32, 'NetGroupDel');
    NetGroupDelUser := GPA (hNetApi32, 'NetGroupDelUser');
    NetGroupGetUsers := GPA (hNetApi32, 'NetGroupGetUsers');
    NetGroupSetUsers := GPA (hNetApi32, 'NetGroupSetUsers');
    NetLocalGroupAdd := GPA (hNetApi32, 'NetLocalGroupAdd');
    NetLocalGroupAddMember := GPA (hNetApi32, 'NetLocalGroupAddMember');
    NetLocalGroupEnum := GPA (hNetApi32, 'NetLocalGroupEnum');
    NetLocalGroupGetInfo := GPA (hNetApi32, 'NetLocalGroupGetInfo');
    NetLocalGroupSetInfo := GPA (hNetApi32, 'NetLocalGroupSetInfo');
    NetLocalGroupDel := GPA (hNetApi32, 'NetLocalGroupDel');
    NetLocalGroupDelMember := GPA (hNetApi32, 'NetLocalGroupDelMember');
    NetLocalGroupGetMembers := GPA (hNetApi32, 'NetLocalGroupGetMembers');
    NetLocalGroupSetMembers := GPA (hNetApi32, 'NetLocalGroupSetMembers');
    NetLocalGroupAddMembers := GPA (hNetApi32, 'NetLocalGroupAddMembers');
    NetLocalGroupDelMembers := GPA (hNetApi32, 'NetLocalGroupDelMembers');
    NetQueryDisplayInformation := GPA (hNetApi32, 'NetQueryDisplayInformation');
    NetGetDisplayInformationIndex := GPA (hNetApi32,
    									  'NetGetDisplayInformationIndex');

	if (Win32Platform = VER_PLATFORM_WIN32_WINDOWS) then
    begin
	    NetAccessAdd := GPA (hNetApi32, 'NetAccessAdd');
		NetAccessEnum := GPA (hNetApi32, 'NetAccessEnum');
        NetAccessGetInfo := GPA (hNetApi32, 'NetAccessGetInfo');
        NetAccessSetInfo := GPA (hNetApi32, 'NetAccessSetInfo');
        NetAccessDel := GPA (hNetApi32, 'NetAccessDel');
        NetAccessGetUserPerms := GPA (hNetApi32, 'NetAccessGetUserPerms');
    end; { if }

    NetGetDCName := GPA (hNetApi32, 'NetGetDCName');
    NetGetAnyDCName := GPA (hNetApi32, 'NetGetAnyDCName');
    I_NetLogonControl := GPA (hNetApi32, 'I_NetLogonControl');
    I_NetLogonControl2 := GPA (hNetApi32, 'I_NetLogonControl2');
    NetEnumerateTrustedDomains := GPA (hNetApi32, 'NetEnumerateTrustedDomains');
end; { initialization }
