...
var
    NetWkstaGetInfo : function (servername: LPWSTR; level: DWORD;
      var bufptr: LPBYTE): NET_API_STATUS; stdcall = NIL;
    {$EXTERNALSYM NetWkstaGetInfo}

    NetWkstaSetInfo : function (servername: LPWSTR; level: DWORD; buffer: Pointer;
      parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;
    {$EXTERNALSYM NetWkstaSetInfo}

    NetWkstaUserGetInfo : function (reserved: LPWSTR; level: DWORD;
      var bufptr: LPBYTE): NET_API_STATUS; stdcall = NIL;
    {$EXTERNALSYM NetWkstaUserGetInfo}

    NetWkstaUserSetInfo : function (reserved: LPWSTR; level: DWORD; buf: Pointer;
      parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;
    {$EXTERNALSYM NetWkstaUserSetInfo}

    NetWkstaUserEnum : function (servername: LPWSTR; level: DWORD; var bufptr: LPBYTE;
      prefmaxlen: DWORD; var entriesread: DWORD; var totalentries: DWORD;
      var resumehandle: DWORD): NET_API_STATUS; stdcall = NIL;
    {$EXTERNALSYM NetWkstaUserEnum}

    NetWkstaTransportAdd : function (servername: LPWSTR; level: DWORD; buf: Pointer;
      parm_err: PDWORD): NET_API_STATUS; stdcall = NIL;
    {$EXTERNALSYM NetWkstaTransportAdd}

    NetWkstaTransportDel : function (servername: LPWSTR; transportname: LPWSTR;
      ucond: DWORD): NET_API_STATUS; stdcall = NIL;
    {$EXTERNALSYM NetWkstaTransportDel}

    NetWkstaTransportEnum : function (servername: LPWSTR; level: DWORD;
...
begin
	...
	NetWkstaGetInfo := GPA (hNetApi32, 'NetWkstaGetInfo');
	NetWkstaSetInfo := GPA (hNetApi32, 'NetWkstaSetInfo');
	NetWkstaUserGetInfo := GPA (hNetApi32, 'NetWkstaUserGetInfo');
	NetWkstaUserSetInfo := GPA (hNetApi32, 'NetWkstaUserSetInfo');
	NetWkstaUserEnum := GPA (hNetApi32, 'NetWkstaUserEnum');
	NetWkstaTransportAdd := GPA (hNetApi32, 'NetWkstaTransportAdd');
	NetWkstaTransportDel := GPA (hNetApi32, 'NetWkstaTransportDel');
	NetWkstaTransportEnum := GPA (hNetApi32, 'NetWkstaTransportEnum');
end; { initialization }
