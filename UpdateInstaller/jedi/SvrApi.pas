...
begin
  ...
  else LibHandle := LoadLibrary(cSvrApi);
...
{$ELSE}
function NetAccessAdd; external cSvrApi name 'NetAccessAdd';
function NetAccessCheck; external cSvrApi name 'NetAccessCheck';
function NetAccessDel; external cSvrApi name 'NetAccessDel';
function NetAccessEnum; external cSvrApi name 'NetAccessEnum';
function NetAccessGetInfo; external cSvrApi name 'NetAccessGetInfo';
function NetAccessSetInfo; external cSvrApi name 'NetAccessSetInfo';
function NetAccessGetUserPerms; external cSvrApi name 'NetAccessGetUserPerms';
function NetShareAdd; external cSvrApi name 'NetShareAdd';
function NetShareDel; external cSvrApi name 'NetShareDel';
function NetShareEnum; external cSvrApi name 'NetShareEnum';
function NetShareGetInfo; external cSvrApi name 'NetShareGetInfo';
function NetShareSetInfo; external cSvrApi name 'NetShareSetInfo';
function NetSessionDel; external cSvrApi name 'NetSessionDel';
function NetSessionEnum; external cSvrApi name 'NetSessionEnum';
function NetSessionGetInfo; external cSvrApi name 'NetSessionGetInfo';
function NetConnectionEnum; external cSvrApi name 'NetConnectionEnum';
function NetFileClose2; external cSvrApi name 'NetFileClose2';
function NetFileEnum; external cSvrApi name 'NetFileEnum';
function NetServerGetInfo; external cSvrApi name 'NetServerGetInfo';
function NetSecurityGetInfo; external cSvrApi name 'NetSecurityGetInfo';
{$ENDIF}
