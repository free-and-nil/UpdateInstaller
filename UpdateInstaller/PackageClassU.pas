...
ResourceString
    ...
    cFirmwareRevisionFoundMsg = 'Firmware version = "%s"';
        ...
        begin
            ...
            begin
                ...
                begin
                    ...
                    LogMsg (cFirmwareRevisionFoundMsg, [sVersion]);
                    Break;
                end; { if }
            end; { for }
        end; { if }
    ...
    begin  // ThinkPad X13 Yoga Gen. 2 -> Multiple firmware values
        ...
        begin
            ...
            begin
                ...
                begin
                    if (VersionToStr (sDeviceVer, FInstalledVersion)) and
...
begin
    ...
    begin
        Result := true;
        LogVerbose (cProcessReturnCodeMsg, [dwExitCode]);
    end { if }
