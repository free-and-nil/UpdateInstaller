...
var
  NetServerEnum : function (servername: LPCWSTR; level: DWORD; var bufptr: Pointer;
    prefmaxlen: DWORD; var entriesread: DWORD; var totalentries: DWORD;
    servertype: DWORD; domain: LPCWSTR; resume_handle: PDWORD): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerEnum}

  NetServerEnumEx : function (ServerName: LPCWSTR; Level: DWORD; var Bufptr: Pointer;
    PrefMaxlen: DWORD; var EntriesRead: DWORD; var totalentries: DWORD;
    servertype: DWORD; domain, FirstNameToReturn: LPCWSTR): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerEnumEx}

  NetServerGetInfo : function (servername: LPWSTR; level: DWORD;
    var bufptr: Pointer): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerGetInfo}

  NetServerSetInfo : function (servername: LPWSTR; level: DWORD; buf: Pointer;
    ParmError: PDWORD): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerSetInfo}

  // Temporary hack function.

  NetServerSetInfoCommandLine : function (argc: Word; argv: LPWSTR): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerSetInfoCommandLine}

  NetServerDiskEnum : function (servername: LPWSTR; level: DWORD; bufptr: Pointer;
    prefmaxlen: DWORD; var entriesread: DWORD; var totalentries: DWORD;
    resume_handle: PDWORD): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerDiskEnum}

  NetServerComputerNameAdd : function (ServerName: LPWSTR; EmulatedDomainName: LPWSTR;
    EmulatedServerName: LPWSTR): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerComputerNameAdd}

  NetServerComputerNameDel : function (ServerName, EmulatedServerName: LPWSTR): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerComputerNameDel}

  NetServerTransportAdd : function (servername: LPWSTR; level: DWORD;
    bufptr: Pointer): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerTransportAdd}

  NetServerTransportAddEx : function (servername: LPWSTR; level: DWORD;
    bufptr: Pointer): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerTransportAddEx}

  NetServerTransportDel : function (servername: LPWSTR; level: DWORD;
    bufptr: Pointer): NET_API_STATUS; stdcall = NIL;
  {$EXTERNALSYM NetServerTransportDel}

  NetServerTransportEnum : function (servername: LPWSTR; level: DWORD; bufptr: Pointer;
    prefmaxlen: DWORD; var entriesread: DWORD; var totalentries: DWORD;
  ...
  SetServiceBits : function (hServiceStatus: SERVICE_STATUS_HANDLE;
    dwServiceBits: DWORD; bSetBitsOn: BOOL; bUpdateImmediately: BOOL): BOOL; stdcall = NIL;
...
begin
	...
	NetServerEnum := GPA (hNetApi32, 'NetServerEnum');
	NetServerEnumEx := GPA (hNetApi32, 'NetServerEnumEx');
	NetServerGetInfo := GPA (hNetApi32, 'NetServerGetInfo');
	NetServerSetInfo := GPA (hNetApi32, 'NetServerSetInfo');
(**
	NetServerSetInfoCommandLine := GPA (hNetApi32, 'NetServerSetInfoCommandLine');
**)
	NetServerDiskEnum := GPA (hNetApi32, 'NetServerDiskEnum');
	NetServerComputerNameAdd := GPA (hNetApi32, 'NetServerComputerNameAdd');
	NetServerComputerNameDel := GPA (hNetApi32, 'NetServerComputerNameDel');
	NetServerTransportAdd := GPA (hNetApi32, 'NetServerTransportAdd');
	NetServerTransportAddEx := GPA (hNetApi32, 'NetServerTransportAddEx');
	NetServerTransportDel := GPA (hNetApi32, 'NetServerTransportDel');
	NetServerTransportEnum := GPA (hNetApi32, 'NetServerTransportEnum');
(**
	SetServiceBits := GPA (hNetApi32, 'SetServiceBits');
**)
end; { initialization }
